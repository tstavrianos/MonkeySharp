...
internal static class TestCompilerCommon
{
    ...
    private static bool TestHashValue(MonkeyObject obj, IReadOnlyDictionary<MonkeyObject, object> dictionary,
        out string errorMessage)
    {
        ...
        {
            errorMessage = $"wrong num of elements. want={dictionary.Count}, got={hash.Pairs.Count}";
            return false;
        }
    ...
    private static bool TestArrayValue(MonkeyObject obj, object[] objects, out string errorMessage)
    {
        ...
        {
            errorMessage = $"wrong num of elements. want={objects.Length}, got={array.Elements.Length}";
            return false;
        }
