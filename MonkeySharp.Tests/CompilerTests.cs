...
public class CompilerTests
{
    ...
    [
        new object[]
        {
            ...
            new[]
            {
                Code.Make(OpCode.Constant, 0), Code.Make(OpCode.Constant, 1), Code.Make(OpCode.Add),
        ...
        new object[]
        {
            ...
            new[]
            {
                Code.Make(OpCode.Constant, 0), Code.Make(OpCode.Constant, 1), Code.Make(OpCode.Subtract),
                Code.Make(OpCode.Pop)
            }
        },
        new object[]
        {
            ...
            new[]
            {
                Code.Make(OpCode.Constant, 0), Code.Make(OpCode.Constant, 1), Code.Make(OpCode.Multiply),
                Code.Make(OpCode.Pop)
            }
        },
        new object[]
        {
            ...
            new[]
            {
                Code.Make(OpCode.Constant, 0), Code.Make(OpCode.Constant, 1), Code.Make(OpCode.Divide),
                Code.Make(OpCode.Pop)
            }
        },
        new object[]
        ...
        new object[]
        {
            "if (true) { 10 }; 3333;", new object[] {10, 3333},
            new[]
            {
                Code.Make(OpCode.True),
        ...
        new object[]
        {
            "if (true) { 10 } else { 20 }; 3333;", new object[] {10, 20, 3333},
            new[]
            {
                Code.Make(OpCode.True),
                Code.Make(OpCode.JumpNotTruthy, 10),
        ...
        new object[]
        {
            "let one = 1; let two = 2;", new object[] {1, 2},
            new[]
            {
                Code.Make(OpCode.Constant, 0),
        ...
        new object[]
        {
            "let one = 1; let two = one; two;", new object[] {1},
            new[]
            {
                Code.Make(OpCode.Constant, 0),
                Code.Make(OpCode.SetGlobal, 0),
        ...
        new object[]
        {
            "[1 + 2, 3 - 4, 5 * 6]", new object[] {1, 2, 3, 4, 5, 6},
            new[]
            {
                Code.Make(OpCode.Constant, 0),
                Code.Make(OpCode.Constant, 1),
        ...
        new object[]
        {
            "[1, 2, 3][1 + 1]", new object[] {1, 2, 3, 1, 1},
            new[]
            {
                Code.Make(OpCode.Constant, 0),
                Code.Make(OpCode.Constant, 1),
        ...
        new object[]
        {
            "let noArg = fn() { 24 }; noArg();", new object[]
            {
                24,
                new[]
                {
        ...
        new object[]
        {
            "fn() { let a = 55; let b = 77; a + b }", new object[]
            {
                55, 77,
                new[]
                {
        ...
        new object[]
        {
            "let oneArg = fn(a) { a }; oneArg(24);", new object[]
            {
                new[]
                {
                    Code.Make(OpCode.GetLocal, 0),
        ...
        new object[]
        {
            "let manyArg = fn(a, b, c) { a; b; c }; manyArg(24, 25, 26);", new object[]
            {
                new[]
                {
                    Code.Make(OpCode.GetLocal, 0),
        ...
        new object[]
        {
            "fn(a) { fn(b) { fn(c) { a + b + c } } }", new object[]
            {
                new[]
                {
                    Code.Make(OpCode.GetFree, 0),
