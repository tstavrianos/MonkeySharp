...
public class VmTests
{
    ...
    [
        ...
        new object[] {"let oneAndTwo = fn() { let one = 1; let two = 2; one + two; };oneAndTwo();", 3},
        new object[]
        {
        ...
        new object[] {"let newClosure = fn(a) { fn() { a; }; }; let closure = newClosure(99); closure();", 99},
        new object[] {"let newAdder = fn(a, b) {fn(c) { a + b + c };};let adder = newAdder(1, 2);adder(8);", 11},
        new object[]
        ...
        new object[] {"let countDown = fn(x) {if (x == 0) {return 0;} else {countDown(x - 1);}};countDown(1);", 0},
        new object[]
        {
