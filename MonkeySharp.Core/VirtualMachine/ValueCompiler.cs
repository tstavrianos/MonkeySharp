...
public class ValueCompiler
{
    ...
    public ValueCompiler(SymbolTable symbolTable, List<Value> constants)
    {
    ...
    public ValueByteCode ByteCode()
    {
        return new ValueByteCode(CurrentInstructions().ToArray(), _constants.ToArray());
    }
