...
public sealed class FunctionData
{
    ...
    internal FunctionData(IReadOnlyList<Identifier> parameters, BlockStatement body, SymbolTable symbolTable)
    {
...
public readonly struct Value : IEquatable<Value>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Value PrefixOperation(string op, Value right)
    {
        if (op == "!")
        {
            if (right.IsBoolean)
